...
from .phiva import phiva_loader, phiva_model, phiva_quantization
...
MODELS: Dict[str, Model] = {
    ...
    "phiva": Model(
        name="phiva",
        model=phiva_model.PhivaForCasualLM,
        config=phiva_model.PhivaConfig,
        source={
            "huggingface-torch": phiva_loader.huggingface,
            "huggingface-safetensor": phiva_loader.huggingface,
        },
        quantize={
            "no-quant": phiva_quantization.no_quant,
            "group-quant": phiva_quantization.group_quant,
        },
    ),
    "qwen": Model(
        name="qwen",
